...
function datesArray(startDate, endDate) {
    ...
    for(i=0;i<dates.length;i++){
        dates[i] = convertDateToCkId(dates[i]);
    }
...
function TriTabId() {
    ...
    while (switching) {
        ...
        for (i = 1; i < (rows.length - 1); i++) {
            ...
            if (Number(x.innerHTML.substr(10, 2)) > Number(y.innerHTML.substr(10, 2))) {
                shouldSwitch = true;
                break;
            }
        }
...
window.onload = TriTabId();

jQuery(function ($) {
    $("a.drop_down_choosen_Closed").click(function () {
        var table, tr, td, i;
        table = document.getElementById("table");
        tr = table.getElementsByTagName("tr");
        ...
        for (i = 0; i < tr.length; i++) {
            ...
            if (td) {
                if (td.getElementsByTagName("a")[0].getElementsByTagName("span")[0].innerHTML == 'Closed') {
                    tr[i].style.display = "";
                } else {
                    tr[i].style.display = "none";
                }
    ...
    $("a.drop_down_choosen_Open").click(function () {
        var table, tr, td, i;
        table = document.getElementById("table");
        tr = table.getElementsByTagName("tr");
        ...
        for (i = 0; i < tr.length; i++) {
            td = tr[i].getElementsByTagName("td")[7];
            if (td) {
                if (td.getElementsByTagName("a")[0].getElementsByTagName("span")[0].innerHTML == 'Open') {
                    tr[i].style.display = "";
                } else {
                    tr[i].style.display = "none";
                }
    ...
    $("a.drop_down_choosen_Hold").click(function () {
        var table, tr, td, i;
        table = document.getElementById("table");
        tr = table.getElementsByTagName("tr");
        ...
        for (i = 0; i < tr.length; i++) {
            td = tr[i].getElementsByTagName("td")[7];
            if (td) {
                if (td.getElementsByTagName("a")[0].getElementsByTagName("span")[0].innerHTML == 'On Hold') {
                    tr[i].style.display = "";
                } else {
                    tr[i].style.display = "none";
                }
